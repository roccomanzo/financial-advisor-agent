...
try:
    ...
    # Globally mock GCP credentials for local server processes when ADC is missing
...
try:
    if os.environ.get("INTEGRATION_TEST") == "TRUE":
        raise ValueError("Running in integration test mode, use standard logger")
...
app.title = "financial-advisor-agent"
